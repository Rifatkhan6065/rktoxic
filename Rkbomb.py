...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : rifatkhan6065 Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Rifatkhan6065 \033[94m│".center(columns+9))
